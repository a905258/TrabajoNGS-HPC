...
![**Figure 1:** Efficiency of the process to obtain FastQCs.](seff FastQC.png)
...
![**Figure 2:** Flow diagram of DNA processing.](DNA diagram.png)   
...
![**Figure 3:** Efficiency of the process to obtain .bam files without duplicates.](seff duplicados todas las muestras.png)
...
![**Figure 4:** Efficiency of the process to generate vcfs.](seff vcf todas las muestras.png)
...
![**Figure 5:** Efficiency of the process to obtain the reports of the vcfs.](seff vcf report todas las muestras .png)
...
![**Figure 6:** Efficiency of the process to obtain the recalibrated .bam files.](seff recalibration 1 muestra .png)
...
![**Figure 10.** Efficiency of the process to obtain .maf files.](seff maftools muestra 24.png)
...
![**Figure 11.** Efficiency of the process to do Kallisto.](seff Kallisto.png)
...
Differential expression analysis revealed that between the normal and malignant groups of patients, there are x transcripts altered with an FDR < 0.01 and a beta > |3|. Moreover, x of them belong to the overexpressed group (beta > 3) whereas x of the isoforms are underexpressed (beta < -3). The labelled transcripts are the ones whose expression was plotted through a boxplot in the previous image. 
