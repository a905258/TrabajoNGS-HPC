...
```{r, eval=FALSE, echo=TRUE, message = FALSE, warning=FALSE}
STAR --runThreadN 3 --genomeDir /scratch/a905208/FinalWork/STAR/index --readFilesIn /scratch/a905208/FinalWork/fastq/SRR645259_1.fastq /scratch/a905208/FinalWork/fastq/SRR645259_2.fastq --outFileNamePrefix S1_test --outSAMtype BAM SortedByCoordinate --outSAMunmapped Within --outSAMattributes NH HI AS NM MD
```
