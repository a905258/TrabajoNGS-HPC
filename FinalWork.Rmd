...
The RNAseq2 dataframe has 199,169 transcrits.
...
sleuth_table<-load ("~/Desktop/TrabajoNGS-HPC/sleuth_table_lrt.RData")
sleuth_significant<-load ("~/Desktop/TrabajoNGS-HPC/sleuth_significant_lrt.RData")
