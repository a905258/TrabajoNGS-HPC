...
Once all the *FastQCs* were obtained, the efficiency of the process was analysed after having used the indicated resources and the results are shown in Figure 1. In particular, it can be seen that both the efficiency of the memory and the CPU were very low, indicating that the resources used were excessive. In other words, resources were wasted. Therefore, it can be concluded that the results would have been better if the amount of memory had been reduced and if fewer CPUs had been used.
...
First of all, the BWA samples were obtained, and then the index had to be built. To build it the FASTA file of the reference genome was obtained from the Ensembl webpage [@cunningham2022ensembl]. To perform this task no Atlas job was performed, since the FASTA was directly downloaded by using the command line:
...
After having checked that the code worked and that the output was correct, the job-array was run to obtain the reports of all the samples and finally the efficiency of the process was checked and this is shown in Figure 6. In particular, it was observed that the efficiencies were lower than expected, so it would have been more optimal to reduce the resources. 


![**Figure 6:** Efficiency of the process to obtain the reports of the vcfs.](./images/seff vcf report todas las muestras .png)
...
This process was performed with the help of "Ensembl.org" website. As this process was not possible to parallelize, each student uploaded two samples of normal .vcf files in order to be annotated. As this website is free of charge, the speed was not outstanding and took around five hours of runtime for each sample to be annotated.
...
GeneTranscriptLocation <- getBM(attributes=c("ensembl_gene_id","ensembl_transcript_id","chromosome_name","transcript_start","transcript_end"),mart=mart) #258710 trnascrips reported
```
...
![**Figure 12.** Part of the RNASeq2 dataframe.](./images/muestra_de_RNAseq2.png)

### 3.4. Design and contrast matrices

Next, we will explain both the design and contrast matrices that have been built. The variable that will be studied is the sample type, that is, the difference in gene expression between normal and malignant samples. We will take as reference the normal samples. 
...
![**Figure 13.** Design matrix.](./images/modelmatrix.png)
...
![**Figure 12.** Sleuth significant matrix.](./images/sleuth_significant.png)
...
![**Figure 13.** EnrichGO database.](./images/database_enrichGO.png)
...
![**Figure 14.** EnrichGO simplified database.](./images/database_enrichGO_simplified.png)
...
![**Figure 15.** Dotplot.](./images/Dotplot.png)
...
![**Figure 16.** Chromosome segregation function.](./images/GO_chromosome_seggregation.png)
...
![**Figure 17.** Genes related to the chromosome seggregation.](./images/genes_chromosome_seggregation.png)
...
![**Figure 18.** IGV showing TACC3 and FGFR3.](./images/IGV.png)
...
![**Figure 19.** PCA plot.](./images/PCAplot.png)
...
![**Figure 20.** Heatmap.](./images/Heatmap.png)
...
![**Figure 21.** Boxplot data frame.](./images/data_boxplot.png)
...
![**Figure 22.** Boxplot.](./images/Boxplot.png)
...
![**Figure 23.** Volcano plot.](./images/Volcano plot.png)
