...
![**Figure 1:** Efficiency of the process to obtain FastQCs.](images/seff%20FastQC.png)
...
![**Figure 2:** Flow diagram of DNA processing.](images/DNA%20diagram.png)
...
![**Figure 3:** Efficiency of the process to obtain .bam files without duplicates.](images/seff%20duplicados%20todas%20las%20muestras.png)
...
![**Figure 4:** Efficiency of the process to generate vcfs.](images/seff%20vcf%20todas%20las%20muestras.png)
...
![**Figure 5:** Efficiency of the process to obtain the reports of the vcfs.](images/seff%20vcf%20report%20todas%20las%20muestras%20.png)
...
![**Figure 6:** Efficiency of the process to obtain the recalibrated .bam files.](images/seff%20recalibration%201%20muestra%20.png)
...
![**Figure 10.** Efficiency of the process to obtain .maf files.](images/seff%20maftools%20muestra%2024.png)
...
![**Figure 11:** Flow diagram of CNV Analysis.](images/CNV%20Diagram.png)
...
This file was used as the *Figure 11* shows to generate the raw counts. But then, the intervals were filtered to be able to collect the allelic counts. A bin length of 10,000 was used to reduce computation cost.  
...
![**Figure 12:** Inputs to generate Intervals.](images/Filter%20Diagram.png)
...
![**Figure 13:** Efficiency of the process by Collect Raw Counts. ](images/seff_CNV.png)
...
![**Figure 14:** Efficiency of the process by Collect Raw Counts (Tumor). ](images/seff_CNV_tumor.png)
...
The input read counts are first transformed to log2 fractional coverages and preprocessed according to specified filtering and imputation parameters. Singular value decomposition (SVD) is then performed to find the first number-of-eigensamples principal components, which are stored in the PoN. 
...
![**Figure 15:** Efficiency of the process by CreateReadCountPanelOfNormals. ](images/seff_PON.png)
...
![**Figure 16:** Efficiency of the process by DenoiseReadCounts. ](images/seff_Standarized.png)
...
```
![**Figure 17:** Efficiency of the process by PlotDenoisedCopyRatios. ](images/seff_plotter.png)
...
```
![**Figure 18:** Efficiency of the process by Collect Allelic Counts. ](images/seff_allelic.png)
...
![**Figure 19:** Efficiency of the process by Collect Allelic Counts. ](images/seff_modelsegments.png)
...
* Two examples of the results have been attached:  
    ...
    + [SRR645209_cleaned](data/SRR645209_cleaned.seg)

    + [SRR645210_cleaned](data/SRR645210_cleaned.seg)

* All samples loaded into IGV. 

![**Figure 20:** Analyzing all counts together.](images/igv_seg.png)
...
![**Figure 11.** Efficiency of the process to do Kallisto.](images/seff%20Kallisto.png)

### 4.2. Procesamiento de datos RNA-Seq
